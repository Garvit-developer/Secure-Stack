...
const Navbar = ({ darkMode, setDarkMode }) => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-[#F2F4F8]/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 transition-colors duration-300">
